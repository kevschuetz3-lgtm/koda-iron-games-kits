...
const SHIRTS = [
  { id: 'unisex-red',             garment: 'unisex', label: 'Red',             product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-red.jpg',             sw: '#c8392e', chest: { cy: 41, w: 37 }, sleeve: { x: 84, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-asphalt',         garment: 'unisex', label: 'Asphalt',         product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-asphalt.jpg',         sw: '#4c4a48', chest: { cy: 41, w: 37 }, sleeve: { x: 84, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-black',           garment: 'unisex', label: 'Black',           product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-black.jpg',           sw: '#1b1b1b', chest: { cy: 41, w: 37 }, sleeve: { x: 84, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-vintage-denim',   garment: 'unisex', label: 'Vintage Denim',   product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-vintage-denim.jpg',   sw: '#8a9aab', chest: { cy: 41, w: 37 }, sleeve: { x: 84, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-synthetic-green', garment: 'unisex', label: 'Synthetic Green', product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-synthetic-green.jpg', sw: '#2aa457', chest: { cy: 41, w: 37 }, sleeve: { x: 84, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-berry',           garment: 'unisex', label: 'Berry',           product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-berry.jpg',           sw: '#d54387', chest: { cy: 41, w: 37 }, sleeve: { x: 84, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-purple-storm',    garment: 'unisex', label: 'Purple Storm',    product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-purple-storm.jpg',    sw: '#6a5b62', chest: { cy: 41, w: 37 }, sleeve: { x: 84, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-lavender-blue',   garment: 'unisex', label: 'Lavender Blue',   product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-lavender-blue.jpg',   sw: '#8d99cf', chest: { cy: 41, w: 37 }, sleeve: { x: 84, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
