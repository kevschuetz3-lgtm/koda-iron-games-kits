...
const SHIRTS = [
  { id: 'unisex-red',             garment: 'unisex', label: 'Red',             product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-red.jpg',             sw: '#c8392e', chest: { cy: 41, w: 42 }, sleeve: { x: 82, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-asphalt',         garment: 'unisex', label: 'Asphalt',         product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-asphalt.jpg',         sw: '#4c4a48', chest: { cy: 41, w: 42 }, sleeve: { x: 82, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-black',           garment: 'unisex', label: 'Black',           product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-black.jpg',           sw: '#1b1b1b', chest: { cy: 41, w: 42 }, sleeve: { x: 82, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-vintage-denim',   garment: 'unisex', label: 'Vintage Denim',   product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-vintage-denim.jpg',   sw: '#8a9aab', chest: { cy: 41, w: 42 }, sleeve: { x: 82, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-synthetic-green', garment: 'unisex', label: 'Synthetic Green', product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-synthetic-green.jpg', sw: '#2aa457', chest: { cy: 41, w: 42 }, sleeve: { x: 82, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-berry',           garment: 'unisex', label: 'Berry',           product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-berry.jpg',           sw: '#d54387', chest: { cy: 41, w: 42 }, sleeve: { x: 82, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-purple-storm',    garment: 'unisex', label: 'Purple Storm',    product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-purple-storm.jpg',    sw: '#6a5b62', chest: { cy: 41, w: 42 }, sleeve: { x: 82, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'unisex-lavender-blue',   garment: 'unisex', label: 'Lavender Blue',   product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-lavender-blue.jpg',   sw: '#8d99cf', chest: { cy: 41, w: 42 }, sleeve: { x: 82, y: 29.5, w: 8.5, rot: 32 }, bg: '50% 45%' },
  { id: 'crop-heather-dust',      garment: 'crop',   label: 'Heather Dust',    product: 'Bella+Canvas 8882 Flowy Crop', img: 'assets/shirts/crop-heather-dust.jpg', sw: '#e0d6cb', chest: { cy: 44, w: 44 }, sleeve: { x: 84.5, y: 31.5, w: 9.5, rot: 35 }, bg: '50% 45%' },
  { id: 'crop-black',             garment: 'crop',   label: 'Black',           product: 'Bella+Canvas 8882 Flowy Crop', img: 'assets/shirts/crop-black.jpg',        sw: '#1a1a1a', chest: { cy: 44, w: 44 }, sleeve: { x: 84.5, y: 31.5, w: 9.5, rot: 35 }, bg: '50% 45%' },
  { id: 'crop-solid-vintage-navy',garment: 'crop',   label: 'Vintage Navy',    product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-vintage-navy.jpg', sw: '#46525e', chest: { cy: 42, w: 30 }, sleeve: { x: 77, y: 31.5, w: 7, rot: 30 }, bg: '50% 45%' },
  { id: 'crop-solid-maroon',      garment: 'crop',   label: 'Maroon',          product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-maroon.jpg',   sw: '#5c2431', chest: { cy: 42, w: 30 }, sleeve: { x: 77, y: 31.5, w: 7, rot: 30 }, bg: '50% 45%' },
  { id: 'crop-solid-forest',      garment: 'crop',   label: 'Forest',          product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-forest.jpg',   sw: '#173428', chest: { cy: 42, w: 30 }, sleeve: { x: 77, y: 31.5, w: 7, rot: 30 }, bg: '50% 45%' },
  { id: 'crop-solid-pink',        garment: 'crop',   label: 'Pink',            product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-pink.jpg',     sw: '#f5a3b0', chest: { cy: 42, w: 30 }, sleeve: { x: 77, y: 31.5, w: 7, rot: 30 }, bg: '50% 45%' },
  { id: 'crop-solid-cocoa',       garment: 'crop',   label: 'Cocoa',           product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-cocoa.jpg',    sw: '#5d4038', chest: { cy: 42, w: 30 }, sleeve: { x: 77, y: 31.5, w: 7, rot: 30 }, bg: '50% 45%' },
];
