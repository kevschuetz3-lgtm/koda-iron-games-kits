...
const SHIRTS = [
  { id: 'unisex-red',             garment: 'unisex', label: 'Red',             product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-red.jpg',             sw: '#c8392e', chest: { cy: 39, w: 35 },   sleeve: { x: 77.5, y: 33, w: 12, rot: -12 },   bg: '50% 38%' },
  { id: 'unisex-asphalt',         garment: 'unisex', label: 'Asphalt',         product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-asphalt.jpg',         sw: '#4c4a48', chest: { cy: 39, w: 35 },   sleeve: { x: 77, y: 33, w: 12, rot: -12 },     bg: '50% 38%' },
  { id: 'unisex-black',           garment: 'unisex', label: 'Black',           product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-black.jpg',           sw: '#1b1b1b', chest: { cy: 37, w: 40 },   sleeve: { x: 80, y: 31, w: 13, rot: -12 },     bg: '50% 36%' },
  { id: 'unisex-vintage-denim',   garment: 'unisex', label: 'Vintage Denim',   product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-vintage-denim.jpg',   sw: '#9db6c4', chest: { cy: 38.5, w: 35 }, sleeve: { x: 78, y: 32.5, w: 12, rot: -12 },   bg: '50% 38%' },
  { id: 'unisex-synthetic-green', garment: 'unisex', label: 'Synthetic Green', product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-synthetic-green.jpg', sw: '#3fbf4e', chest: { cy: 38, w: 36 },   sleeve: { x: 77.5, y: 32, w: 12, rot: -12 },   bg: '50% 37%' },
  { id: 'unisex-berry',           garment: 'unisex', label: 'Berry',           product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-berry.jpg',           sw: '#cf4f92', chest: { cy: 37, w: 40 },   sleeve: { x: 80, y: 31, w: 13, rot: -12 },     bg: '50% 36%' },
  { id: 'unisex-purple-storm',    garment: 'unisex', label: 'Purple Storm',    product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-purple-storm.jpg',    sw: '#6d5d68', chest: { cy: 39, w: 36 },   sleeve: { x: 78, y: 33, w: 12, rot: -12 },     bg: '50% 38%' },
  { id: 'unisex-lavender-blue',   garment: 'unisex', label: 'Lavender Blue',   product: 'Bella+Canvas 3001 Unisex Tee', img: 'assets/shirts/unisex-lavender-blue.jpg',   sw: '#a3abdc', chest: { cy: 38, w: 36 },   sleeve: { x: 78, y: 32, w: 12, rot: -12 },     bg: '50% 37%' },
  { id: 'crop-heather-dust',      garment: 'crop',   label: 'Heather Dust',    product: 'Bella+Canvas 8882 Flowy Crop', img: 'assets/shirts/crop-heather-dust.jpg', sw: '#e0d6cb', chest: { cy: 41, w: 46 }, sleeve: { x: 83, y: 25, w: 15, rot: 20 },  bg: '50% 42%' },
  { id: 'crop-black',             garment: 'crop',   label: 'Black',           product: 'Bella+Canvas 8882 Flowy Crop', img: 'assets/shirts/crop-black.jpg',        sw: '#1a1a1a', chest: { cy: 41, w: 48 }, sleeve: { x: 84.5, y: 24, w: 15, rot: 20 }, bg: '50% 42%' },
  { id: 'crop-solid-vintage-navy',garment: 'crop',   label: 'Vintage Navy',    product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-vintage-navy.jpg', sw: '#4e5a67', chest: { cy: 35, w: 25 },   sleeve: { x: 66.5, y: 29.5, w: 8, rot: -14 },   bg: '50% 42%' },
  { id: 'crop-solid-maroon',      garment: 'crop',   label: 'Maroon',          product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-maroon.jpg',   sw: '#59242e', chest: { cy: 35, w: 25, cx: 49.5 },   sleeve: { x: 66, y: 29.5, w: 8, rot: -14 }, bg: '50% 42%' },
  { id: 'crop-solid-forest',      garment: 'crop',   label: 'Forest',          product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-forest.jpg',   sw: '#1f3c2c', chest: { cy: 35, w: 25 },   sleeve: { x: 65.5, y: 29.5, w: 8, rot: -14 },   bg: '50% 42%' },
  { id: 'crop-solid-pink',        garment: 'crop',   label: 'Pink',            product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-pink.jpg',     sw: '#f0b9c4', chest: { cy: 35.5, w: 24, cx: 47.5 }, sleeve: { x: 64.5, y: 30, w: 8, rot: -14 },   bg: '50% 42%' },
  { id: 'crop-solid-cocoa',       garment: 'crop',   label: 'Cocoa',           product: 'Bella+Canvas 1010 Baby Tee', img: 'assets/shirts/crop-solid-cocoa.jpg',    sw: '#6b4f43', chest: { cy: 35, w: 25, cx: 49 },   sleeve: { x: 65.5, y: 29.5, w: 8, rot: -14 },   bg: '50% 42%' },
];
